  ...
  const renderTableHeader = () => {
    return (
      <View style={styles.row}>
        <Text style={[styles.cell, styles.headerCell1]}>Company#/ NMLS ID</Text>
        <Text style={[styles.cell, styles.headerCell2]}>Company Name</Text>
        <Text style={[styles.cell, styles.headerCell3]}>Contact</Text>
        <Text style={[styles.cell, styles.headerCell4]}>Account Executive</Text>
        <Text style={[styles.cell, styles.headerCell5]}>Address</Text>
        <Text style={[styles.cell, styles.headerCell6]}>Select</Text>
      </View>
    );
  };
  ...
  const renderTableRow = (item) => {
    return (
      <View style={styles.row} key={item.id}>
        <Text style={styles.cell_1}>
          {` ${item.UserNum} / ${item.LicenseNum} `}
        </Text>
        <Text style={styles.cell_2}>{item.UserName}</Text>
        <Text style={styles.cell_3}>{item.UserContact}</Text>
        <Text style={styles.cell_4}>
          {`${item.AccountExec} ,${item.CompEmail}`}
        </Text>
        <Text style={styles.cell_5}>
          {`${item.CompAdd1} ,${item.CompCity} ,${item.CompState} ,${item.CompZip} `}
        </Text>
        <View style={[styles.cell, styles.cell_6]}>
          <Button
            title={
      ...
      >
        <View style={styles.container}>
          ...
          <View style={styles.filterContainer}>
            ...
            >
              <Text style={styles.label1}>Search results</Text>
